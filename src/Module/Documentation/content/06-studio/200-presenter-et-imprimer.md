...
## 3. Le sommaire et le pointeur

Deux touches de plus, pour le moment des questions :

- **O** ouvre le **sommaire** : toutes les slides en grille, celle où vous en êtes entourée. Un clic y saute. C'est la réponse à « vous pouvez revenir sur le troisième chapitre ? », qui se paie autrement en dix-neuf flèches devant la salle.
- **P** allume le **pointeur** : un cercle rouge qui suit votre souris. C'est un interrupteur et non une touche à maintenir, parce qu'une touche maintenue se répète et un pointeur qui clignote au rythme du clavier est pire que pas de pointeur.

Les deux boutons sont aussi dans la barre du bas.

**Le curseur de la souris disparaît** quand elle ne bouge plus. Une flèche garée au milieu d'une slide projetée est la tache que personne ne voit sur sa propre présentation. Elle revient au premier mouvement.
...
Si votre système est réglé sur « réduire les animations », il n'y a pas de transition, quel que soit le choix de la présentation. C'est ce que ce réglage demande.
