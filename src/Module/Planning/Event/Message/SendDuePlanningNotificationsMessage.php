...
/**
 * Fired every minute: send whatever alerts are due.
 *
 ...
 * "the alerts due at 14:03" would be a message about a minute that has passed.
 */
final class SendDuePlanningNotificationsMessage {}
