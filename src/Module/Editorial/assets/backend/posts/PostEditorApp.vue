            ...
            <section class="space-y-4">
                ...
                <div v-show="isTabActive('content')" class="space-y-4">
                    <!-- The grid is the body now, not one of two ways to write
                         ...
                         has changed. -->
                    <div v-if="supportsBlocks" class="aurora-card p-3 sm:p-5 space-y-3">
                    ...
                    <div v-if="customFieldDefinitions.length" class="aurora-card p-3 sm:p-5 space-y-4">
                ...
                <div v-show="isTabActive('settings')" class="space-y-4">
                    ...
                    <div v-if="availableTaxonomies.length" class="aurora-card p-3 sm:p-5 space-y-3">
                    ...
                    <div class="aurora-card p-3 sm:p-5 space-y-3">
                        ...
                        <div
                            ...
                            class="rounded-lg border border-line divide-y divide-line/40 overflow-hidden"
                        >
                            <button
